...
import { faEye, faEyeSlash, faUserShield, faEnvelope, faLock } from '@fortawesome/free-solid-svg-icons';
...
export class AppModule {
  constructor() {
    library.add(faEye, faEyeSlash, faUserShield, faEnvelope, faLock, faGoogle, faFacebook, faGithub);
  }
 }
